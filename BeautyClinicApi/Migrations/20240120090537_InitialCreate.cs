    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentService", x => new { x.AppointmentsAppointmentId, x.ServicesServiceId });
                    table.ForeignKey(
                        name: "FK_AppointmentService_Appointments_AppointmentsAppointmentId",
                        column: x => x.AppointmentsAppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "AppointmentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentService_Services_ServicesServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentService_ServicesServiceId",
